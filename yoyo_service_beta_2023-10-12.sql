...
# Database: yoyo_service_beta
# Generation Time: 2023-10-12 10:20:13 +0000
# ************************************************************
...
CREATE TABLE `coin_trade_ext` (
  ...
  `sysMinPrice` double NOT NULL DEFAULT '0.5' COMMENT '系统最低价',
...
CREATE TABLE `user` (
  ...
  `contryCode` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `aliPayName` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `v_task_record` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  UNIQUE KEY `VId` (`VId`,`CDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
