...
# Database: hwjd_db
# Generation Time: 2023-10-12 10:20:36 +0000
# ************************************************************
...
CREATE TABLE `backstage_user` (
  ...
  `openId` varchar(50) NOT NULL DEFAULT '0' COMMENT '开放平台ID',
...
CREATE TABLE `coin_trade` (
  ...
  `tradeNumber` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `orderType` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'YB' COMMENT '类型',
  ...
  `amount` decimal(32,2) DEFAULT NULL COMMENT '币种数量',
  `price` decimal(18,2) DEFAULT NULL COMMENT '单价',
  `totalPrice` decimal(18,2) DEFAULT NULL COMMENT '总价',
...
CREATE TABLE `coin_trade_ext` (
  ...
  `sysMaxPrice` double NOT NULL DEFAULT '10' COMMENT '系统最高价',
  `sysMinPrice` double NOT NULL DEFAULT '0.01' COMMENT '系统最低价',
  ...
  `orderType` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '钻石' COMMENT '类型',
  PRIMARY KEY (`id`)
...
# Dump of table everyday_dividend
# ------------------------------------------------------------

DROP TABLE IF EXISTS `everyday_dividend`;

CREATE TABLE `everyday_dividend` (
...
CREATE TABLE `login_history` (
  ...
  `IP` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT 'IP',
  PRIMARY KEY (`id`),
...
CREATE TABLE `nft` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `cId` int(11) NOT NULL DEFAULT '0' COMMENT '当前所属用户id',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '当前状态0初始 1 出售中 2 质押中',
  ...
  `income` decimal(18,4) NOT NULL DEFAULT '0.0000' COMMENT '竞拍点',
  `record` text NOT NULL COMMENT '历史持有者',
...
# Dump of table nlog_dblog
# ------------------------------------------------------------

DROP TABLE IF EXISTS `nlog_dblog`;

CREATE TABLE `nlog_dblog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `machineName` varchar(200) NOT NULL DEFAULT '',
  `logged` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `message` text,
...
CREATE TABLE `order_games` (
  ...
  KEY `FK_createdAt` (`createdAt`),
  KEY `FK_updatedAt` (`updatedAt`),
  KEY `FK_gameAppid_userId_status` (`gameAppid`,`userId`,`status`) USING HASH
...
# Dump of table qq_client_rember
# ------------------------------------------------------------

DROP TABLE IF EXISTS `qq_client_rember`;

CREATE TABLE `qq_client_rember` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `cId` int(11) NOT NULL DEFAULT '0',
  `qqNum` varchar(200) NOT NULL DEFAULT '0',
  `ctime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
# Dump of table qq_email_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `qq_email_record`;

CREATE TABLE `qq_email_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tId` int(11) NOT NULL DEFAULT '0',
  `sId` int(11) NOT NULL DEFAULT '0',
  `nick` varchar(200) NOT NULL DEFAULT '',
  `qqNum` varchar(200) NOT NULL DEFAULT '',
  `groupNum` varchar(200) NOT NULL DEFAULT '',
...
# Dump of table qq_email_service
# ------------------------------------------------------------

DROP TABLE IF EXISTS `qq_email_service`;

CREATE TABLE `qq_email_service` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uId` varchar(200) NOT NULL DEFAULT '1',
  `tId` int(11) NOT NULL DEFAULT '1',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '1 可用 0被拉黑',
  `emailFrom` varchar(200) NOT NULL DEFAULT 'x@outlook.com',
  `smtpHost` varchar(200) NOT NULL DEFAULT 'smtp.office365.com',
  `smtpPort` varchar(200) NOT NULL DEFAULT '587',
  `smtpUser` varchar(200) NOT NULL DEFAULT 'x@outlook.com',
  `smtpPass` varchar(200) DEFAULT NULL,
  `maxCount` int(11) NOT NULL DEFAULT '3' COMMENT '当日最大发送次数',
  `hCount` int(11) NOT NULL DEFAULT '0' COMMENT '已发送次数',
  `tip` text,
  `ctime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
# Dump of table qq_luck
# ------------------------------------------------------------

DROP TABLE IF EXISTS `qq_luck`;

CREATE TABLE `qq_luck` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `luck` text NOT NULL,
  `lang` varchar(50) NOT NULL DEFAULT 'ch',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# Dump of table qq_majia
# ------------------------------------------------------------

DROP TABLE IF EXISTS `qq_majia`;

CREATE TABLE `qq_majia` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `qqNum` varchar(200) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `qq_type` (
  ...
  `remark` text NOT NULL COMMENT '通知文案',
  `nWord` text COMMENT '关键词',
...
# Dump of table s_appeals
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_appeals`;

CREATE TABLE `s_appeals` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `appealResult` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品订单申诉表';



# Dump of table s_coin_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_coin_type`;

CREATE TABLE `s_coin_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table s_minnings
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_minnings`;

CREATE TABLE `s_minnings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` bigint(20) NOT NULL COMMENT '用户id',
  `minningId` int(11) NOT NULL COMMENT '矿机类型 id',
  `beginTime` datetime NOT NULL COMMENT '生效时间',
  ...
  `source` int(3) DEFAULT NULL COMMENT '0:系统赠送(试炼矿机); 1:购买/兑换; 2:达人奖励；3：游戏奖励；4：城市合伙人赠送',
  `type` int(3) NOT NULL DEFAULT '0' COMMENT '0 普通矿机 1荣耀矿机',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `begin_time` (`beginTime`) USING BTREE,
  KEY `user_id` (`userId`) USING BTREE,
  KEY `end_time` (`endTime`) USING BTREE,
...
CREATE TABLE `s_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `orderNum` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单编号',
  `shopId` int(11) NOT NULL DEFAULT '0' COMMENT '商品ID',
  `userId` int(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `type` int(11) NOT NULL DEFAULT '0' COMMENT '支付方式 0 糖果 1 YB 2 USDT',
  `amount` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '支付金额',
  `totalPrice` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '总价',
  `count` int(11) NOT NULL DEFAULT '1' COMMENT '物品件数',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '0 未支付 1 取消 2 支付成功 3 已发货 4 确认收货 5 申请退款 6 订单完成',
  `postNum` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '快递编号',
  `postService` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '快递服务放',
  `postPrice` decimal(11,2) NOT NULL DEFAULT '1.00' COMMENT '快递费',
  `adressId` int(11) NOT NULL DEFAULT '0' COMMENT '收货地址ID',
  `remark` text COLLATE utf8mb4_unicode_ci COMMENT '备注',
  `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `payTime` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '支付时间',
  `postTime` datetime DEFAULT NULL COMMENT '发货时间',
  `sureTime` datetime DEFAULT NULL COMMENT '收货时间',
  `updateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `s_shop` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `shopTypeId` int(11) NOT NULL DEFAULT '0' COMMENT '商品类别',
  `userId` bigint(20) NOT NULL DEFAULT '0' COMMENT '商家ID',
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品名称',
  `sort` int(11) NOT NULL DEFAULT '0',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态 0 下架 1 正常',
  `canCandyBuyAmount` int(11) NOT NULL DEFAULT '0' COMMENT '可以糖果购买数量',
  `totalAmount` int(11) NOT NULL DEFAULT '1' COMMENT '商品总数量',
  `candyPrice` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '糖果价格',
  `pX` int(11) NOT NULL DEFAULT '1' COMMENT '比例系数',
  `ybPrice` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT 'YB价格',
  `usdtPrice` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT 'USDT价格',
  `rewaardYB` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '奖励YB',
  `price` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '原价',
  `truePrice` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '成本价格',
  `remark` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '备注',
  `postPrice` decimal(11,2) NOT NULL DEFAULT '1.00' COMMENT '邮费',
  `adress` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '货源地',
  `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `s_type` (
  ...
  `url` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片URL',
  `name` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '类别名称',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '0 下架 1 在线',
...
# Dump of table s_user_account_shard
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_user_account_shard`;

CREATE TABLE `s_user_account_shard` (
...
# Dump of table s_user_account_shard_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_user_account_shard_record`;

CREATE TABLE `s_user_account_shard_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
  `PostChange` decimal(18,5) NOT NULL COMMENT '变更后金额',
...
# Dump of table s_user_account_wallet
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_user_account_wallet`;

CREATE TABLE `s_user_account_wallet` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
...
# Dump of table s_user_account_wallet_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_user_account_wallet_record`;

CREATE TABLE `s_user_account_wallet_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
...
# Dump of table s_yoyo_task_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `s_yoyo_task_record`;

CREATE TABLE `s_yoyo_task_record` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
# Dump of table sp_stores
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sp_stores`;

CREATE TABLE `sp_stores` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL DEFAULT '0',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `logoPic` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order` int(11) NOT NULL DEFAULT '0',
  `type` int(2) NOT NULL DEFAULT '0' COMMENT '0 全部  1 美食 2 娱乐 3 生活服务 4日用百货 5 其他',
  `telPhone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `dAddress` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '定位地址',
  `latitude` decimal(11,6) NOT NULL DEFAULT '0.000000',
  `longitude` decimal(11,6) NOT NULL DEFAULT '0.000000',
  `remark` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(2) NOT NULL DEFAULT '0' COMMENT '0 未审核 1 上线 2拒绝',
  `isPay` int(2) NOT NULL DEFAULT '1' COMMENT '0 不支持支付 1 支持支付',
  `cTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `user` (
  ...
  `auditState` int(11) NOT NULL DEFAULT '0' COMMENT '0:审核中, 1:审核通过, 2:审核未通过',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rcode` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contryCode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `mobile` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `gcs` decimal(18,4) NOT NULL DEFAULT '0.0000' COMMENT '量化gc收益',
  ...
  `avatarUrl` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'images/avatar/default/1.png',
  ...
  `alipayUid` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `aliPayName` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `IP` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '用户IP',
  PRIMARY KEY (`id`),
  ...
  KEY `FK_inviter_mobile` (`inviterMobile`),
  KEY `NORMAL_ALIPAY_AUDITSTATE` (`alipay`,`auditState`)
...
# Dump of table user_account_gc
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_gc`;

CREATE TABLE `user_account_gc` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_gc_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_gc_record`;

CREATE TABLE `user_account_gc_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
# Dump of table user_account_gcx
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_gcx`;

CREATE TABLE `user_account_gcx` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_gcx_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_gcx_record`;

CREATE TABLE `user_account_gcx_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
# Dump of table user_account_jifen
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_jifen`;

CREATE TABLE `user_account_jifen` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_jifen_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_jifen_record`;

CREATE TABLE `user_account_jifen_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
# Dump of table user_account_jifenxf
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_jifenxf`;

CREATE TABLE `user_account_jifenxf` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_jifenxf_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_jifenxf_record`;

CREATE TABLE `user_account_jifenxf_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
# Dump of table user_account_shard
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_shard`;

CREATE TABLE `user_account_shard` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_shard_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_shard_record`;

CREATE TABLE `user_account_shard_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
# Dump of table user_account_xfq
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_xfq`;

CREATE TABLE `user_account_xfq` (
  `AccountId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '账户ID',
  `UserId` bigint(20) NOT NULL COMMENT '用户ID',
  `Revenue` decimal(18,5) NOT NULL COMMENT '总收入',
  `Expenses` decimal(18,5) NOT NULL COMMENT '总支出',
...
# Dump of table user_account_xfq_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `user_account_xfq_record`;

CREATE TABLE `user_account_xfq_record` (
  `RecordId` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `AccountId` bigint(20) NOT NULL COMMENT '账户ID',
  `PreChange` decimal(18,5) NOT NULL COMMENT '变更前金额',
  `Incurred` decimal(18,5) NOT NULL COMMENT '发生金额',
...
CREATE TABLE `user_ext` (
  ...
  `teamCandyH` int(11) NOT NULL DEFAULT '0' COMMENT '团队果核',
  `bigCandyH` int(11) NOT NULL DEFAULT '0' COMMENT '大区果核',
  `littleCandyH` int(11) NOT NULL DEFAULT '0',
  `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_locations` (
  ...
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_cityCode` (`cityCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='位置记录';
...
# Dump of table v_task_record
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_task_record`;

CREATE TABLE `v_task_record` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `VId` int(11) NOT NULL DEFAULT '0',
  `UserId` int(11) NOT NULL DEFAULT '0',
  `dlOrderId` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `x_nft`;

CREATE TABLE `x_nft` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `luckNum` varchar(59) NOT NULL DEFAULT '-1',
  `chainHash` varchar(200) NOT NULL DEFAULT '' COMMENT '链上hash',
  `cHash` varchar(200) NOT NULL COMMENT '合约hash',
  `status` int(11) NOT NULL COMMENT '0 预售 1预售中 2已停止',
  `name` varchar(200) NOT NULL DEFAULT '' COMMENT 'nft名称',
  `price` decimal(11,2) NOT NULL DEFAULT '1.00' COMMENT 'nft价格',
  `amount` int(11) NOT NULL DEFAULT '2000' COMMENT '发行份数',
  `hAmount` int(11) NOT NULL DEFAULT '0' COMMENT '已购买份数',
  `auId` int(11) NOT NULL DEFAULT '0' COMMENT '作者类型',
  `type` int(11) NOT NULL DEFAULT '0' COMMENT '0 gc 1荣耀碎片',
  `pic` varchar(200) DEFAULT NULL COMMENT '主图',
  `picUv` varchar(200) DEFAULT NULL COMMENT '主图uv',
  `objPath` varchar(200) DEFAULT NULL COMMENT '模型obj',
  `remark` text NOT NULL COMMENT '藏品故事',
  `bTime` datetime DEFAULT NULL COMMENT '抽签时间',
  `eTime` datetime DEFAULT NULL COMMENT '抽签结束时间',
...
# Dump of table x_nft_au
# ------------------------------------------------------------

DROP TABLE IF EXISTS `x_nft_au`;

CREATE TABLE `x_nft_au` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `typeName` varchar(200) NOT NULL DEFAULT '' COMMENT '系列名称',
  `auName` varchar(200) NOT NULL DEFAULT '' COMMENT '作者名',
  `fxName` varchar(200) DEFAULT NULL COMMENT '发行方',
  `pic` varchar(200) NOT NULL DEFAULT '' COMMENT '作者logo',
  `cTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
# Dump of table x_nft_cq
# ------------------------------------------------------------

DROP TABLE IF EXISTS `x_nft_cq`;

CREATE TABLE `x_nft_cq` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `nftId` int(11) NOT NULL COMMENT 'nft编号',
  `uId` int(11) NOT NULL COMMENT '用户Id',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '0 未中 1中',
  `cTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
# Dump of table x_nft_me
# ------------------------------------------------------------

DROP TABLE IF EXISTS `x_nft_me`;

CREATE TABLE `x_nft_me` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `hash` varchar(200) NOT NULL DEFAULT '' COMMENT 'hash',
  `nftId` int(11) NOT NULL COMMENT 'nft编号',
  `uId` int(11) NOT NULL COMMENT '用户Id',
  `price` decimal(11,2) NOT NULL DEFAULT '1.00' COMMENT '出售价',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '0 未出售 1出售中',
  `record` text NOT NULL COMMENT '转增记录',
  `czVal` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '战力值',
  `cTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '时间',
  `uTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid_nftId` (`nftId`,`uId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;



# Dump of table yjj_do
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yjj_do`;

CREATE TABLE `yjj_do` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `inviterMobile` varchar(20) NOT NULL DEFAULT '',
  `mobile` varchar(20) NOT NULL DEFAULT '',
  `code` varchar(20) NOT NULL DEFAULT '',
  `imageCode` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE `yoyo_ad_click` (
  ...
  KEY `FK_UserId,_ClickDate` (`UserId`,`ClickDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `yoyo_bang_category` (
  ...
  `MinPrice` decimal(10,2) NOT NULL COMMENT '最小价格',
  `Sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
...
CREATE TABLE `yoyo_luckydraw_prize` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_yoyo_luckydraw_prize_Name` (`Name`),
  KEY `IX_yoyo_luckydraw_prize_CreatedTime` (`CreatedTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `yoyo_luckydraw_round` (
  ...
  `CreatedTime` datetime(6) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_yoyo_luckydraw_round_Status` (`Status`),
  KEY `IX_yoyo_luckydraw_round_Level` (`Level`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `yoyo_luckydraw_user` (
  ...
  KEY `IX_yoyo_luckydraw_user_RoundId` (`RoundId`),
  KEY `IX_yoyo_luckydraw_user_CreatedTime` (`CreatedTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `yoyo_member_duplicate` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `UK_Date_UserId` (`Date`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `yoyo_member_invite_ranking` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `FK_Phase_UserId` (`Phase`,`UserId`),
  KEY `FK_InviteTotal` (`InviteTotal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
# Dump of table yoyo_member_star_now
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoyo_member_star_now`;

CREATE TABLE `yoyo_member_star_now` (
  `UserId` bigint(20) NOT NULL,
  `teamStart` int(11) NOT NULL DEFAULT '0',
  `teamCandyH` int(11) NOT NULL DEFAULT '0',
  `bigCandyH` int(11) NOT NULL DEFAULT '0',
  `littleCandyH` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `yoyo_task_record` (
  ...
  `Remark` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`Id`) USING BTREE,
  UNIQUE KEY `USER_DATE` (`UserId`,`CreateDate`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;



# Dump of table yoyo_transfer_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoyo_transfer_order`;

CREATE TABLE `yoyo_transfer_order` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `OrderNo` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Type` int(11) NOT NULL COMMENT '1转出至小鱼  2转入至哟哟吧',
  `YoUid` bigint(20) NOT NULL,
  `YoUuid` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Amount` decimal(11,4) NOT NULL,
  `Fee` decimal(11,4) NOT NULL,
  `XyUuid` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `XyOrderNo` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `State` int(3) NOT NULL COMMENT '1已发送  2已完成',
  `CreateTime` datetime NOT NULL,
  `Remark` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CoinName` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE,
